class Gladiator:
    # skills is dictionary {technique: skill}
...
while not data == 'Ave Cesar':
    ...
    if len(splitted_data) == 3:
        ...
        if fighter_1 in gladiators_names_list and fighter_2 in gladiators_names_list:
            fighter_1_techiques_list = list(filter(lambda gl: gl.gladiator_name == fighter_1, gladiators_list))[0].skills.keys()
            fighter_2_techiques_list = list(filter(lambda gl: gl.gladiator_name == fighter_2, gladiators_list))[0].skills.keys()
